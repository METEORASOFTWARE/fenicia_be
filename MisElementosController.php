...
if ($method == 'GET') {
	...
	if (!isset($propietario)) {
		...
		$respuesta = array(	"success" 	=> false,
												"name" 			=> "BAD REQUEST",
												"message" 	=> "Parametro propietario NO enviado.",
												"code"			=> "400.1"
								);
		...
		$MisElementos 	= new MisElementos();
		$elemntData 	= $MisElementos->getAllMisElementos($propietario);
